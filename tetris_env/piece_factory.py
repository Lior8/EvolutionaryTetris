class PieceFactory:
    def __init__(self, width):
        ...
        self.pieces = [
            [[[1], [1], [1], [1]], [[1, 1, 1, 1]]],  # I
            [[[2, 2], [2, 2]]],  # O
            [[[3, 3, 3], [0, 3]], [[0, 3], [3, 3], [0, 3]], [[0, 3], [3, 3, 3]], [[3], [3, 3], [3]]],  # T
            [[[0, 4, 4], [4, 4]], [[4], [4, 4], [0, 4]]],  # S
            [[[5, 5], [0, 5, 5]], [[0, 5], [5, 5], [5]]],  # Z
            [[[0, 6], [0, 6], [6, 6]], [[6], [6, 6, 6]], [[6, 6], [6], [6]], [[6, 6, 6], [0, 0, 6]]],  # J
            [[[7], [7], [7, 7]], [[7, 7, 7], [7]], [[7, 7], [0, 7], [0, 7]], [[0, 0, 7], [7, 7, 7]]]  # L
        ]
    ...
    def calculate_piece_size(self, piece):
        ...
        """
        return len(piece), max(len(row) for row in piece)
